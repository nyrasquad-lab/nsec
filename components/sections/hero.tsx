      ...
      <div className="container relative z-10 grid min-h-[calc(100vh-4rem)] grid-cols-1 items-center gap-12 py-16 lg:grid-cols-2 lg:py-0">
        <div>
          ...
          <h1 className="text-5xl font-bold leading-tight tracking-tight text-white md:text-6xl lg:text-7xl">
            ...
            <br />
            Group
            <span className="ml-1 inline-block w-[3px] bg-cyan-400 align-middle" style={{ height: '0.85em', opacity: showCursor ? 1 : 0, boxShadow: showCursor ? '0 0 8px rgba(0,212,255,0.8)' : 'none' }} />
          </h1>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4">
            ...
            <Link href="/#services">
              <button className="flex items-center gap-2.5 rounded-lg border border-white/15 bg-white/5 px-6 py-3 text-sm font-medium text-white/80 transition-all hover:border-white/30 hover:bg-white/10">
                <svg className="h-3.5 w-3.5 text-cyan-400" viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z" /></svg>
                Explore Services
              </button>
            </Link>
          </div>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-6">
            <div className="flex items-center gap-2 text-sm text-white/40">
              <svg className="h-4 w-4 text-cyan-500/60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}><path d="M12 2L3 7v6c0 5 4 9.4 9 10.9 5-1.5 9-5.9 9-10.9V7L12 2z" /></svg>
              SOC 2 · ISO 27001
            </div>
            <div className="flex items-center gap-2 text-sm text-white/40">
              <svg className="h-4 w-4 text-cyan-500/60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}><polyline points="4 17 10 11 4 5" /><line x1="12" y1="19" x2="20" y2="19" /></svg>
